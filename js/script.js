const global = {
  ...
  api: {
    apiKey: "422d32be93bbeeda444e1b0576a48f28",
...
async function displayPopularShows() {
  ...
  results.forEach((tv) => {
    ...
    <p class="card-text">
    <small class="text-muted">Air_Date :  ${tv.first_air_date}</small>
    </p>
    </div>`;
...
async function search() {
  ...
  if (global.search.term !== "" && global.search.term !== null) {
    ...
    showAlert("Please enter a name of a movie or a tv show!");
  }
}
...
// Display backdrop image on ditails pages
...
// Additional Function for adding comma to a number
